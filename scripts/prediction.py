...
for normalize in [True, False]:
    for Classifier in [GradientBoostingClassifier, TabPFNClassifier]:
        cls = Classifier(random_state=0)
        ...
        path_out = Path(f'results/normalized_{normalize}/{cls.__class__.__name__}')
        ...
        # Retrict overservation between -5 weeks and +10 weeks (mostly NaN otherwise)
        df_steps = df_steps[range(-5*7, 10*7+1)] 
        ...
        targets = [ 
            ...
            ('PROM_12_>Q3', "PROM 12 larger than Q3\nbased on activity", days),
            ('PROM_12_>Q2', "PROM 12 larger than Q2\nbased on activity", days),
            ('PROM_12_>Q1', "PROM 12 larger than Q1\nbased on activity", days),
            ('PROM_12_<Q1', "PROM 12 less than Q1\nbased on activity", days),
            ('recovered', "At least 50% pre-injury activity after 6 weeks\nbased on pre-injury activity", days_pre),
            ('recovered', "At least 50% pre-injury activity after 6 weeks\nbased on pre-injury and 1 week post-injury activity", days[days<1*7]),
        ]
